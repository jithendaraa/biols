...
echo "python train.py --config vector_config.json --num_nodes ${num_nodes} --exp_edges ${exp_edge} --dataseed ${seed}"

cd vae-latent-structure
python train.py --config vector_config.json --num_nodes ${num_nodes} --exp_edges ${exp_edge} --dataseed ${seed}
cd ..
