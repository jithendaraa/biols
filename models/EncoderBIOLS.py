...
class EncoderBIOLS(hk.Module):
    def __init__(self, d, posterior_samples, eq_noise_var, tau, hidden_size, 
                max_deviation, learn_P, proj_dims, interv_value_sampling,
                log_stds_max=10.0, logit_constraint=10, P=None):
        """
    ...
    def _set_vars(self, d, posterior_samples, eq_noise_var, tau,
                    ...
                    logit_constraint, proj_dims, interv_value_sampling, P=None):
        """
    ...
    def __call__(self, rng_key, X, interv_targets, interv_values, LΣ_params, hard):
        """
