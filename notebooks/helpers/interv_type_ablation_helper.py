...
def fetch_and_plot_interv_type_ablation(num_nodes, num_intervs, basepath, runs, reqd_keys, proj='linear', interv_types=['multi', 'single'], box_widths=0.8, fontsize=18):
    ...
    utils.plot_interv_type_ablation(plot_df, basepath, name, reqd_keys, fontsize, interv_types, box_widths=box_widths, title=None)